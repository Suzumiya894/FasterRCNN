...
def train(model):
  ...
  print(f"dir = {options.dataset_dir}")
  print(f"split = {options.train_split}")
  print(f"image_preprocessing_params = {model.backbone.image_preprocessing_params}")
  print(f"compute_feature_map_shape_fn = {model.backbone.compute_feature_map_shape}")
  print(f"feature_pixels = {model.backbone.feature_pixels}")
